        ...
        (function (DataSources) {
            ...
            DataSources.ObtainMolecule = Bootstrap.Tree.Transformer.action({
                ...
                defaultParams: function (ctx) { return ({
                    ...
                    sources: {
                        'CoordinateServer': { kind: 'CoordinateServer', id: '1jmc', type: 'Full', lowPrecisionCoords: true, serverUrl: ctx.settings.get('molecule.downloadBinaryCIFFromCoordinateServer.server') ? ctx.settings.get('molecule.downloadBinaryCIFFromCoordinateServer.server') : 'https://cs.litemol.org' },
                        'PDBe Updated mmCIF': { kind: 'PDBe Updated mmCIF', id: '1jmc' },
        ...
        (function (PDBe) {
            ...
            (function (Data) {
                ...
                Data.DownloadBinaryCIFFromCoordinateServer = Bootstrap.Tree.Transformer.action({
                    ...
                    from: [Entity.Root],
                    to: [Entity.Action],
                    defaultParams: function (ctx) { return ({ id: '1jmc', type: 'Full', lowPrecisionCoords: true, serverUrl: ctx.settings.get('molecule.downloadBinaryCIFFromCoordinateServer.server') ? ctx.settings.get('molecule.downloadBinaryCIFFromCoordinateServer.server') : 'https://cs.litemol.org' }); },
...
(function (LiteMolPluginInstance) {
    ...
    addButton('Fog Factor = 0.5', function () {
        plugin.context.scene.scene.updateOptions({ fogFactor: 0.5 });
    });
    addButton('Fog Factor = 1.0', function () {
    ...
    addButton('Load Ligand', function () {
        ...
        var id = '1jmc:REA';
        var url = "https://cs.litemol.org/1jmc/ligandInteraction?name=REA"; // here you will fill in the full server etc ...
        var action = Transform.build()
    ...
    addButton('Color Sequences', function () {
        ...
        var coloring = {
            ...
            entries: [
                { entity_id: '2', struct_asym_id: 'B', start_residue_number: 119, end_residue_number: 129, color: { r: 255, g: 128, b: 64 } },
                { entity_id: '1', struct_asym_id: 'A', start_residue_number: 1, end_residue_number: 5, color: { r: 64, g: 128, b: 255 } }
            ]
        };
